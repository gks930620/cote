...
public class Main {
    ...
    static void input() {
        ...
        M = scan.nextInt();
        K=scan.nextInt();
        dist = new int[N + 1];   //start부터 N까지의 거리
    ...
    static void dijkstra(int start) {
        ...
        // 최소 힙 생성
        /* TODO */
        PriorityQueue<Info> pq=new PriorityQueue<>((o1, o2) -> o1.dist - o2.dist); //start에서의 거리가 짧은게 먼저나옴
        ...
        while (!pq.isEmpty()) {
            ...
            for (Edge e : edges[info.idx]) {
                ...
                if( dist[e.to] > dist[info.idx] + e.weight ){
                    pq.add(new Info(e.to , dist[info.idx]+e.weight ));
